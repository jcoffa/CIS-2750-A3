...
const char readPath[] = "/home/joseph/cis2750/a02/";
...
void load(char *fileName)
{
    ...
    input = createCalendar(filePath, &calendar);
...
int main(void)
{
	...
	printf("Run INV_CAL tests [0=no, 1=yes]? ");
	scanf("%d", &choice);
...
INVCALXALARM: printf("Run INV_CAL x INV_ALARM tests [0=no, 1=yes]? ");
	scanf("%d", &choice);
...
INVEVENTXALARM:printf("Run INV_EVENT x INV_ALARM tests [0=no, 1=yes]? ");
	scanf("%d", &choice);
...
INVCALXEVENTXALARM: printf("Run INV_CAL x INV_EVENT x INV_ALARM tests [0=no, 1=yes]? ");
	scanf("%d", &choice);
...
OK: printf("Run OK tests [0=no, 1=yes]? ");
	scanf("%d", &choice);
